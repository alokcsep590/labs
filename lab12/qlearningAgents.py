...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in actions:
          ...
          if temp_qvalue == qvalue:
            max_action = random.choice([max_action, action]) # break ties randomly for better behavior
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.qvalues[(state, action)] = currStateValue + (self.alpha * value)
